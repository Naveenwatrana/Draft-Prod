...
import WhatWillYouDo from '/public/images/whatWillYouDo.png';
...
const NoBlocks = ({ onClick }:{onClick?:()=>void }) => {
  ...
  return (
    <BasicDetailsContainer>
      <UserCardContainer>
        <MainContentWrapper>
          <Image src={WhatWillYouDo.src} alt="" width={180} height={180} />
          <RightSection>
            <h4>
              {createJobSteps.details.whatWillYouDoPopup.title}
            </h4>
            <p>{createJobSteps.details.responsibilityCardTypographyTxtTwo}</p>
