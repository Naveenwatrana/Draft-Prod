...
describe('helpers', () => {
  ...
  describe('isFormFilled', () => {
    it('should return true if form is filled', () => {
      const objectUnderTest = { some_property: 'someValue' };
      const result = isFormFilled(objectUnderTest);
      expect(result).toBeTruthy();
    });
    it('should return false if form is not filled', () => {
      const objectUnderTest = { some_property: null };
      const result = isFormFilled(objectUnderTest);
...
describe('reorderArrayByIndex', () => {
  it('should return reordered array', () => {
    const objectUnderTest = [2, 0, 1];
    const order = [2, 0, 1];
    const result = [1, 2, 0];
    const reordered = reorderArrayByIndex(objectUnderTest, order);
